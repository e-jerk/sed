...
/* Missing macros for Zig C compiler compatibility */
#ifndef UCHAR_WIDTH
#define UCHAR_WIDTH 8
#endif
#ifndef UINTPTR_WIDTH
#define UINTPTR_WIDTH (sizeof(void*) * 8)
#endif
#ifndef SETLOCALE_NULL_MAX
#define SETLOCALE_NULL_MAX 256
#endif

/* Override obstack.h pointer alignment macros to avoid null pointer arithmetic.
   gnulib's obstack.h uses (char*)0 as base for pointer alignment on 64-bit systems:
     __PTR_ALIGN(B, P, A) -> __BPTR_ALIGN((char*)0, P, A)
   Zig's C compiler catches `(char*)0 + offset` as undefined behavior.
   This override forces use of the actual base pointer B, which is always safe. */
#ifndef __BPTR_ALIGN
#define __BPTR_ALIGN(B, P, A) ((B) + (((P) - (B) + (A)) & ~(A)))
#endif
/* Always use base pointer (B), never null - safe for Zig's UB detection */
#undef __PTR_ALIGN
